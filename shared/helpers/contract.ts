...
if (!process.env.NEXT_PUBLIC_MULTICALL_CONTRACT) throw new Error("Missing env.NEXT_PUBLIC_MULTICALL_CONTRACT");
export const MULTICALL_CONTRACT = process.env.NEXT_PUBLIC_MULTICALL_CONTRACT as `0x${string}`
