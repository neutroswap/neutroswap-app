...
export type GetPoolListQuery = { __typename?: 'Query', pairs: Array<{ __typename?: 'Pair', id: string, reserve0: any, reserve1: any, reserveUSD: any, reserveEOS: any, trackedReserveEOS: any, untrackedVolumeUSD: any, token0Price: any, token1Price: any, volumeUSD: any, txCount: any, token0: { __typename?: 'Token', id: string, symbol: string, name: string }, token1: { __typename?: 'Token', id: string, symbol: string, name: string }, pairDayData: Array<{ __typename?: 'PairDayData', id: string, date: number, dailyTxns: any, dailyVolumeUSD: any }> }> };
